      ...
      config.json: |
        {
            "default_server_config": {
                "m.homeserver": {
                    "base_url": "https://matrix.zoe.community",
                    "server_name": "matrix.zoe.community"
                },
                "m.identity_server": {
            ...
            "roomDirectory": {
                "servers": [
                        "matrix.zoe.community"
                ]
            },
            "piwik": {
                "url": "https://piwik.riot.im/",
                "whitelistedHSUrls": ["https://matrix.zoe.community"],
                "whitelistedISUrls": ["https://vector.im", "https://matrix.zoe.community"],
                "siteId": 1
            },
            "enable_presence_by_hs_url": {
                "https://matrix.zoe.community": false,
                "https://matrix.zoe.community": false
            },
            "settingDefaults": {
                "breadcrumbs": true
